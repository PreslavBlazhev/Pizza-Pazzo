package bg.pizzapazzo.app.settings
...
class PrinterPreferences(context: Context) {
    ...
    private val prefs: SharedPreferences =
        // The storage name predates the rename to a customer-facing app. It is
        // an internal file name that nobody ever sees, and changing it would
        // only risk orphaning a tablet's printer setup for no gain.
    ...
    companion object {
         ...
         */
        private val LEGACY_DEFAULT_START_URLS = setOf(
    ...
    private fun migrateLegacyStartUrl() {
        ...
        val stored = prefs.getString(KEY_START_URL, null)
        prefs.edit {
            if (stored != null && stored in LEGACY_DEFAULT_START_URLS) {
