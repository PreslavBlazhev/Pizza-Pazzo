...
Android WebView обвивка около сайта на Pizza Pazzo + Bluetooth ESC/POS печат
на кухненски бележки. Отваря се на началната страница; живото табло за поръчки
(`/admin/orders/live`) е на един допир през админ менюто. Началната страница се
